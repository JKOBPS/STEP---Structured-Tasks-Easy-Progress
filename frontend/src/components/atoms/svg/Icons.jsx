...
// Exportaciones de svg

// ICONOS DE BENEFICIOS RÁPIDOS, LANDING PAGE
...
export const UserAvatarIcon = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="currentColor"
    viewBox="0 0 24 24"
...
// Icono Editar (lápiz) y Icono Eliminar (papelera)
